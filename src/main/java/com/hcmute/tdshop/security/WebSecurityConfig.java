...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  private final String[] publicUrlPatterns = {"/v3/api-docs/**", "/swagger-ui/**", "/auth/reset-password**",
      ...
      "/token/refresh", "/", "/order/register-client/**",
      "/order/send-message", "/test/posttest", "/order/send-dummy-message/**"
  };
  @Autowired
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.oauth2Login()
        ...
        .and()
        .successHandler((AuthenticationSuccessHandler) new OAuth2AuthenticationSuccessHandler(appProperties, httpCookieOAuth2AuthorizationRequestRepository, jwtTokenProvider))
