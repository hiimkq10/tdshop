...
public interface ProductService {
  ...
  public DataResponse searchProductsByFilter(String keyword, long categoryId, double maxPrice, double minPrice, String brand, Set<Long> variationOptionIds, Pageable page);
