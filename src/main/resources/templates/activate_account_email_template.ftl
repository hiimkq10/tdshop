                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto"
                                                                src="https://res.cloudinary.com/dd4dftliy/image/upload/v1668846132/logo_jdwasn.png"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                                Please validate your email address in order to activate your account.
                                            </div>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td align="center" bgcolor="#2F67F6" role="presentation"
                                                        style="border:none;border-radius:3px;color:#ffffff;cursor:auto;"
                                                        valign="middle">
                                                        <a style="display:inline-block; padding:15px 25px; text-decoration: none;"
                                                            href=${code}>
                                                            <p
